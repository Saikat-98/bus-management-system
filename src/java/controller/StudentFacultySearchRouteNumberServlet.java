...
public class StudentFacultySearchRouteNumberServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(nsession!=null){
            ...
            try{
                String route_number=request.getParameter("studentfacultysearchroutenumberdetails");
